        ...
        <div className="flex flex-col lg:flex-row items-center justify-between">
          <div className="lg:w-1/2 mb-8 lg:mb-0">
            ...
            <p className="text-xl text-gray-600 mb-8">
              In times of rising living costs, every penny counts. Track your expenses,
              convert currencies, and make data-driven financial decisions.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6 bg-blue-50 rounded-lg">
              ...
              <p className="text-gray-600">
                With Eurozone inflation at 2.3% and US core inflation at 2.8% (November 2024), tracking expenses is more important than ever.
            ...
            <div className="p-6 bg-blue-50 rounded-lg">
              ...
              <p className="text-gray-600">
                With increasing global commerce, managing expenses across different currencies is becoming essential.
              </p>
            </div>
            <div className="p-6 bg-blue-50 rounded-lg">
              <div className="text-blue-500 mb-4">
              ...
              <p className="text-gray-600">
                Research shows that people who track their spending are more likely to achieve their financial goals.
                <span className="block text-xs mt-2 text-gray-500">
                  Source: {' '}
                  <a 
